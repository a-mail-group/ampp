...
func (tx *Tx) EnqueueMessage(queue string,msg *Message) error {
...
func (tx *Tx) ReEnqueueMessage(key []byte,queue string,msg *Message) error {
...
func (tx *Tx) DequeueMessage(queue string) (key []byte,msg *Message,err error) {
...
func (tx *Tx) Enqueue(queue string,from string, to []string, r io.Reader) error {
	...
	return tx.EnqueueMessage(queue,&Message{from,to,data})
}
